    ...
    return (
        <div className='about home'>
            ...
            <div className="a_propos">
                <Collapse class={'a_propos_fiabilite'} title='Fiabilité' state={openCloseFiabilite} function={() => menuOpenClose(openCloseFiabilite, 'fiabilite')}>
                Les annonces postées sur Kasa garantissent une fiabilité totale. Les photos sont conformes aux logements, et toutes les informations sont régulièrement vérifiées par nos équipes.
                </Collapse>

                <Collapse class={'a_propos_respect'} title='Respect' state={openCloseRespect} function={() => menuOpenClose(openCloseRespect, 'respect')}>
                La bienveillance fait partie des valeurs fondatrices de Kasa. Tout comportement discriminatoire ou de perturbation du voisinage entraînera une exclusion de notre plateforme.
                </Collapse>

                <Collapse class={'a_propos_service'} title='Service' state={openCloseService} function={() => menuOpenClose(openCloseService, 'service')}>
                Nos équipes se tiennent à votre disposition pour vous fournir une expérience parfaite. N'hésitez pas à nous contacter si vous avez la moindre question.
                </Collapse>

                <Collapse class={'a_propos_securite'} title='Sécurité' state={openCloseSecurite} function={() => menuOpenClose(openCloseSecurite, 'securite')}>
